...
public class CreateNewAdminAccount extends JFrame implements ActionListener
{
	...
	public CreateNewAdminAccount(String User_Name)
	{
		super("Create New Admin Account");
		...
		buttonInsert.setBounds(180,280,100,30);
		buttonInsert.addActionListener(this);
		panel.add(buttonInsert);
		
		buttonBack = new JButton("Back");
		buttonBack.setBounds(50,350,100,30);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(buttonClicked.equals(buttonBack.getText()))
		{
		    ...
		    String query = "SELECT id, name, email, mobile, address, age, gender FROM user_table where username='"+User_Name+"'";     
